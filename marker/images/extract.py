...
def extract_page_images(page_obj, page, image_flag, min_image_height, min_image_width):
    if image_flag == 0:
        page.images = []
...
def extract_images(doc, pages, image_flag, min_image_height, min_image_width):
    for page_idx, page in enumerate(pages):
        page_obj = doc[page_idx]
        extract_page_images(page_obj, page, image_flag, min_image_height, min_image_width)