...
class PDFProcessor:
    def __init__(self, tesseract_cmd="", poppler_path="", output_path=''):
        """
    ...
    def process_pdf_page(
        ...
        if self.is_scanned_pdf(pdf_path):
            ...
            plt.axis('off') 
            plt.savefig(os.path.join(self.output_path,f'images\\{page_number}.png'), bbox_inches='tight', pad_inches=0, dpi=150)
