                ...
                for current_table in tables_json:
                    for next_table in next_page_tables_json:
                        if self.is_table_continued(
                            ...
                            current_table["table_text"].extend(
                                next_table["table_text"]
                            )
        ...
        with io.BytesIO() as image_buffer:
            ...
            try:
                ...
                for table in extracted_tables:
                    ...
                    table_image = self.extract_table_image(pdf_path, page_num+1, coordinates[0])
                    table_image.save(f'temp.jpg')

                    ocr_text = [self.clean_text(pytesseract.image_to_string(table_image, lang="rus+eng"))]
